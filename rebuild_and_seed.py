...
def rebuild_and_seed():
    print("1. Rebuilding all database tables...")
    # This automatically creates all missing tables with correct columns!
    ...
    try:
        ...
        if db.query(models.Batch).first():
            print("2. Database already contains data! Skipping seed.")
            return

        print("2. Seeding database with test values...")
        ...
        # Create a Food Submission for today
